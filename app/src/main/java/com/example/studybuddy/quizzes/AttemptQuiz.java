...
public class AttemptQuiz extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attmpt_quiz);
        ...
        popGrid=new popGridAdapter(AttemptQuiz.this);
    ...
    void submit(){
        ...
        for(int i=0;i<answers.length;i++){
            ...
            String temp = ( answers[i] != null) ? answers[i]+"" : "--" ;

            list.add(" Your choice      ( "+ temp + " ) \n Right choice is ( "+ questions.get(i).getAnswer()+" )");
            arrayList.add("Q"+ String.valueOf(i+1)+") "+questions.get(i).getQuestion() );
        ...
        try {
            ...
            mDatabase.child("Results").child(key).child(auth.getUid()).setValue(score);
            mDatabase.child("Users").child(auth.getUid()+"/Tests").child(key).child("attempted").setValue(true);
        }catch (Exception e){
    ...
    void dialogStart() {
        ...
        builderSingle.setTitle("View Correct Answers :");
        ...
        builderSingle.setNegativeButton("Done!", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                startActivity(new Intent(AttemptQuiz.this, ClassroomActivity.class));
                finish();
                dialog.dismiss();
            }
        });
        ...
        builderSingle.setAdapter(arrayAdapter1, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                builderInner.setTitle("Selected/Correct Answer is");
    ...
    protected void onPause() {
       ...
       /* if(countPaused<=2 && countPaused >=0 && flag_controller == 1)
           startService(new Intent(AttemptTest.this, NotificationService.class));
        countPaused++;*/
    }
